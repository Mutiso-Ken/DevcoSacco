...
Page 50914 "MC Individual List editable"
{
    Caption = 'Member List';
    CardPageID = "MC Individual Page-editable";
    Editable = false;
    InsertAllowed = false;
    PageType = List;
            ...
            group(ActionGroup1102755007)
            {
                ...
                action("Close Account")
                {
                    ...
                    begin
                        ...
                        Rec.CalcFields("Outstanding Balance", "Accrued Interest", "Current Shares", "Insurance Fund",
    ...
    begin
        ...
        StatusPermissions.SETRANGE(StatusPermissions.Function,StatusPermissions);
