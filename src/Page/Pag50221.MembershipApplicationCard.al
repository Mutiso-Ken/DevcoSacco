Page 50221 "Membership Application Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Junior)
            {
                ...
                field("JuniorSecond Name"; Rec."Second Name")
                {
                    ApplicationArea = Basic;
                    Editable = FistnameEditable;
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        if (Rec."Account Category" = Rec."account category"::Single) then begin
                            ...
                            if (Rec."Account Category" = Rec."account category"::"Group Account") then begin
                                Rec.TestField(Name);
    ...
    begin
        ...
        Cust."Bank Branch" := Rec."Bank Name";
    ...
    begin
        ...
        + BOSAACC + '  Account Name ' + Rec.Name + ' .' + 'You can now Deposit Via PayBill 557239. Thank You For Choosing to Bank With Us';
        IEntry := 0;
        SMSMessages.Reset();
