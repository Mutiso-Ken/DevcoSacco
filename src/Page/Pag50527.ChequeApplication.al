...
Page 50527 "Cheque Application"
{
            ...
            action("Post Cheque Book Application")
            {
                ...
                begin
                   ...
                   */
                    ...
                    FnSendSMSOnChequeApplication();
                    //-----
                    // Message('Dear Member your Cheque Book is ready for Collection, Thank You For Choosing to Bank With Us');

                    Rec."Cheque Book charges Posted" := true;
                    Rec.Modify;

                    Message('Cheque book has been Successfully Applied');
    ...
    local procedure FnSendSMSOnChequeApplication()
    var
    begin
        SMSToSend := 'Dear Member,Your Cheque Book is ready for Collection,Thank You For Choosing to Bank With Us';
        IEntry := 0;
        SMSMessages.Reset();
        ...
        SMSMessages."Document No" := 'CHEQUEBOOKAPPLICATION';
