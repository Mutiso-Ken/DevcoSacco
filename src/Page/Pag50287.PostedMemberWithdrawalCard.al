...
Page 50287 "Posted Member Withdrawal Card"
{
    DeleteAllowed = false;
    Editable = true;
    InsertAllowed = true;
                    ...
                    begin
                        ...
                        if cust.Get(Rec."Member No.") then begin
                            if (Rec."Closure Type" = Rec."closure type"::"Withdrawal - Normal") or (Rec."Closure Type" = Rec."closure type"::"Withdrawal - Death(Defaulter)") then begin
                                ...
                                cust.CalcFields(cust."Outstanding Balance", cust."Outstanding Interest",  "Accrued Interest", "Insurance Fund", "Current Shares");
