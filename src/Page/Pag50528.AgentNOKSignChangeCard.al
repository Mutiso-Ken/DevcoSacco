...
Page 50528 "Agent/NOK/Sign. Change Card"
{
    PageType = Card;
    ...
    var
        ...
        ObjAccountSignatories: Record "Member Account Signatories";
        ...
        if ObjNOKAgentChange.FindSet then begin
            ...
            if ObjMemberNextofKinChange.FindSet then begin
                repeat
                    ...
                    ObjMemberNOKDetails.Relationship := format(ObjMemberNextofKinChange."Next Of Kin Type");
