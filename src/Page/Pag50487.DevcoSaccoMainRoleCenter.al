Page 50487 "Devco Sacco Main Role Center"
{
    Caption = 'Devco SACCO';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(FinancialManagement)
            {
                ...
                {
                    action("Trade Creditors Report")
                    {
                        ApplicationArea = basic, Suite;
                        RunObject = report "Creditors Report";
                    }
                    action(Debtors)
                    {
                        ApplicationArea = all;
                        RunObject = report "Debtors Report";
                    }
                ...
                group("Assets Management")
                {
                    ...
                    action("Assets Report")
                    {
                        ApplicationArea = all;
                        RunObject = report AssetsReport;
            ...
            group(MembershipManagement)
            {
                ...
                group("Member Reports")
                {
                    ...
                    action("Deposit concentration Report")
                    {
                        ApplicationArea = all;
                        RunObject = report DepositConcentrationReport;

                    }
                    action("Deposit Balances Report")
                    {
                        ApplicationArea = all;
                        RunObject = report "Deposit Balances Report";

                    }
                    action("Share concentration Report")
                    {
                        ApplicationArea = all;
                        RunObject = report ShareConcentrationReport;

                    }

                    action("Loan Repayments concentration Report")
                    {
                        ApplicationArea = all;
                        RunObject = report RepaymentConcentrationReport;
                    ...
                    action("Membership Closure Report")
                    {
                        ...
                        RunObject = report MembersExitReport;
            ...
            group(SaccoLoansManagement)
            {
                ...
                group("Loans' Reports")
                {
                    action("Loans _Deposits Report")
                    {
                        ApplicationArea = all;
                        RunObject = report "Loan Deposits & Shares Report";
                    }
                    ...
                    action("Statement of Changes in Equity")
                    {
                        ...
                        Caption = 'Statement of Changes in Equity';
                        RunObject = report StatementOfChangesInEquity;
                        ToolTip = 'Statement of Changes in Equity';
                    }
                    ...
                    action("Loans Perfomance status Report")
                    {
                        ApplicationArea = all;
                        RunObject = Report "loan Performance Status";
                        ToolTip = 'Loans Perfomance Status Report';
                    }
            ...
            group(BosaManagement)
            {
                ...
                group("Guarantor Management")
                {
                    ...
                    action("Guarantor Substitution Lits")
                    {
                        ApplicationArea = Basic, Suite;
                        RunObject = Page "Guarantorship Sub Posted";
                    }
                ...
                group("Defaulter's Management")
                {
                    ...
                    group(loanRecovery)
                    {
                        ...
                        action(SendDemandNotice)
                        {
                            Caption = 'Send Demand Notice';
                ...
                group("BOSA Reports")
                {
                    ...
                    action("Loan Deposits & Shares Report")
                    {
                        Caption = 'Loan Deposits & Shares Report';
                        RunObject = report "Loan Deposits & Shares Report";
                    }
                }
                //.....................................End Of BOSA
            ...
            group("Audit Trails")
            {
                ...
                action("Change Request Posted")
                {
                    ApplicationArea = all;
                    RunObject = report "Change Request Posted";
                }

                action("Change Log Entries")
                {
                    ApplicationArea = all;
                    RunObject = page "Change Log Entries Audit";
                }
            }
