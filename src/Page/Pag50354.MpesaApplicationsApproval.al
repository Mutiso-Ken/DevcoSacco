...
Page 50354 "Mpesa Applications Approval"
{
                        ...
                        if Confirm('Are you sure you would like to approve the application?') = true then begin
                          ...
                          */
                            ...
                            */
                            ...
                            Rec.Status := Rec.Status::Approved;//Status:=Status::"1st Approval";
                ...
                action(Reject)
                {
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you would like to reject the application?') = true then begin
                            ...
                            Rec.Modify;
                            Message('Application for ' + Rec."Customer Name" + ' has been rejected. The Customer will be notified via SMS of the rejection reason.'
                            );
                        end;
                    end;
                }
