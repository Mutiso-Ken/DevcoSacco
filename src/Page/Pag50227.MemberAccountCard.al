...
Page 50227 "Member Account Card"
{
                  ...
                  //  Editable = false;
                    ...
                    begin
                      ...
                      //  StatusPermissions.SetRange(StatusPermissions."User Id", UserId);
                        ...
                        if StatusPermissions.Find('-') = true then
        ...
        area(navigation)
        {
            ...
            group(ActionGroup1102755023)
            {
                ...
                action("Members Kin Details List")
                {
                 ...
                 action("Members Kin Change")
                {
                    ApplicationArea = Basic;
                    Caption = 'Members Kin Change';
                    Image = Relationship;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    RunObject = Page "Member Next Of Kin Change";
                    RunPageLink = "Account No" = field("No.");
                }
                ...
                action("Member is  Guaranteed")
                {
                    ...
                    begin
                        ...
                        Cust.SetRange(Cust."No.", Rec."No.");
                        if Cust.Find('-') then
                            Report.Run(51030, true, false, Cust);
                    end;
                }
                ...
                action("Recover Loans from Gurantors")
                {
                    ...
                    begin
                        ...
                        if Rec."Closing Loan Balance" = 0 then
                            Rec."Closing Loan Balance" := Rec."Outstanding Balance";
                ...
                action("Recover Loans from Deposit")
                {
                    ...
                    begin
                        ...
                        Rec.CalcFields("Outstanding Balance", "Outstanding Interest", "Accrued Interest", "Insurance Fund", "Current Shares");
