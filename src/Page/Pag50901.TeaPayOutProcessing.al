...
Page 50901 "Tea Pay Out Processing"
{
    PageType = Card;
        ...
        area(processing)
        {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    if Rec.Amount <> Rec."Schedule Amount" then
                  ...
                  // END OF LIMITS CHECK
                    */
                    ...
                    TransactionsSchedule.Reset;
                    TransactionsSchedule.SetRange(TransactionsSchedule.No, Rec.No);
                    ...
                    if Confirm('Are you sure you want to deposit this cheque?', false) = true then begin
                        ...
                        GenJournalLine."Due Date" := Rec."Expected Maturity Date";
                        GenJournalLine.Description := 'Payout Processing' + ' ' + Rec."Cheque No";
                        ...
                        Rec."Date Deposited" := Today;
                        Rec."Time Deposited" := Time;
                        Rec."Deposited By" := UserId;
                        Rec.Modify;
