    ...
    dataset
    {
        dataitem("Payroll Employee."; "Payroll Employee.")
        {
            ...
            dataitem("prPeriod Transactions."; "prPeriod Transactions.")
            {
                ...
                column(HousingLevyRelief; HousingLevyRelief)
                {
                ...
                begin
                    ...
                    prPeriodTransactions2.SetRange("Transaction Code", 'HSLR');
                    if prPeriodTransactions2.FindFirst then
                        HousingLevyRelief := prPeriodTransactions2.Amount;
                    //End of Housing Levy Relief
