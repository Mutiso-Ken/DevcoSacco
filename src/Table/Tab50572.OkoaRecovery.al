...
table 50572 "Okoa Recovery"
{
    ...
    fields
    {
        ...
        field(10; "Payoff Amount"; Decimal)
        {

            trigger OnValidate()
            begin
                GenSetUp.Get;
                if "Payoff Amount" > GenSetUp."OKoa Limit" then begin
        ...
        field(28; "Overdraft balance"; Decimal)
        {
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Account No", "Application date", "Approved Date", "Captured by", "Account Name", "Outstanding Overdraft", "Payoff Amount", "Date Filter", "Phone No")
        {
        }
    }
    ...
    begin
        if "Document no" = '' then begin
            ...
            NoSeriesMgt.InitSeries(SaccoSetup."OVerdraft Nos", xRec."No. Series", 0D, "Document no", "No. Series");
        end;
    end;
