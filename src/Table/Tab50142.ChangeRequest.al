...
table 50142 "Change Request"
{
    ...
    fields
    {
        ...
        field(2; Type; Option)
        {
            ...
            OptionMembers = "BOSA Change","Next Of Kin Change";
            trigger OnValidate()
            begin
                "Account No" := '';
            end;
            ...
            begin
                ...
                if Type = Type::"BOSA Change" then begin
                    ...
                    if Memb.Find('-') then begin
                        ...
                        "Remitance Mode(new)" := Memb."Remitance Mode";
                        "Bank Branch Code" := Memb."Bank Branch";
                    end;
                end;
                if Type = Type::"Next Of Kin Change" then begin
                    // Delete previous NewKIN records
                    NewKIN.Reset;
                    NewKIN.SetRange(NewKIN."Change Request no", No);
                    if NewKIN.FindFirst then
                        NewKIN.DeleteAll;

                    // Delete previous RemovedNextOfKins records
                    RemovedNextOfKins.Reset;
                    RemovedNextOfKins.SetRange(RemovedNextOfKins."Change Request no", No);
                    if RemovedNextOfKins.FindFirst then
                        RemovedNextOfKins.DeleteAll;

                    // Copy current NOK to NewKIN and RemovedNextOfKins
                    OldKin.Reset;
                    OldKin.SetRange(OldKin."Account No", "Account No");
                    if OldKin.FindFirst then begin
                        repeat
                            // Insert into NewKIN
                            NewKIN.Init;
                            NewKIN."Account No" := OldKin."Account No";
                            NewKIN."Full Names" := OldKin.Name;
                            NewKIN.Relationship := OldKin.Relationship;
                            NewKIN.Beneficiary := OldKin.Beneficiary;
                            NewKIN."Identification No." := OldKin."ID No.";
                            NewKIN."Date of Birth" := OldKin."Date of Birth";
                            NewKIN."%Allocation" := OldKin."%Allocation";
                            NewKIN."Phone No" := OldKin.Telephone;
                            NewKIN."Change Request no" := No;
                            NewKIN.Insert;

                            // Also insert into RemovedNextOfKins
                            RemovedNextOfKins.Init;
                            RemovedNextOfKins."Account No" := OldKin."Account No";
                            RemovedNextOfKins."Full Names":= OldKin.Name;
                            RemovedNextOfKins.Relationship := OldKin.Relationship;
                            RemovedNextOfKins.Beneficiary := OldKin.Beneficiary;
                            RemovedNextOfKins."Identification No.":= OldKin."ID No.";
                            RemovedNextOfKins."Date of Birth" := OldKin."Date of Birth";
                            RemovedNextOfKins."%Allocation" := OldKin."%Allocation";
                            RemovedNextOfKins."Phone No" := OldKin.Telephone;
                            RemovedNextOfKins."Change Request no" := No;
                            RemovedNextOfKins.Insert;
                        until OldKin.Next = 0;
                    end;

                    // Optionally assign Name for info purposes
                    Memb.Reset;
                    Memb.SetRange(Memb."No.", "Account No");
        ...
        field(11; City; Code[100])
        {
        }
        field(12; "E-mail"; Code[100])
        {
        }
        field(13; "Personal No"; Code[100])
        {
        }
        ...
        field(18; "Account Type"; Code[100])
        {
        }
        ...
        field(25; "Sub-Location"; Code[100])
        {
        }
        field(26; District; Code[100])
        {
        }
        ...
        field(38; "ATM Collector Name"; Code[100])
        {
        }
        field(39; "ATM Collectors ID"; Code[20])
        {
        }
        field(40; "Atm Collectors Moile"; Code[100])
        {
        }
        ...
        field(50; "Member Cell Group"; Code[100])
        {
        ...
        field(51; "Member Cell Name"; Code[100])
        {
        }
        field(52; "Group Account No"; Code[100])
        {
            TableRelation = Customer."No." where("Group Account" = filter(true));
        }
        field(53; "Group Account Name"; Code[100])
        {
        }
        ...
        field(57; "No. Series(New Value)"; Code[100])
        {
        }
        field(58; "Address(New Value)"; Code[100])
        {
        }
        field(59; "Branch(New Value)"; Code[100])
        {
        }
        ...
        field(62; "City(New Value)"; Code[100])
        {
        }
        ...
        field(64; "Personal No(New Value)"; Code[100])
        {
        }
        ...
        field(67; "Passport No.(New Value)"; Code[100])
        {
        }
        ...
        field(69; "Account Type(New Value)"; Code[100])
        {
        }
        ...
        field(73; "Card No(New Value)"; Code[100])
        {
        }
        ...
        field(76; "Sub-Location(New Value)"; Code[100])
        {
        }
        field(77; "District(New Value)"; Code[100])
        {
        }
        ...
        field(121; "Remitance Mode(new)"; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ","Check off","Non-Check off";
        }
        field(122; "Remitance Mode"; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ","Check off","Non-Check off";
        }
    ...
    var
        ...
        messages: label 'Impossible Deletion';
        OldKin: Record "Members Next Kin Details";
        RemovedNextOfKins: Record "Old Next Of Kins";
}
