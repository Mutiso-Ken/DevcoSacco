...
table 50149 "Member Agent/Next Of Kin Chang"
{
    ...
    var
        ...
        ObjMemberNOKDetails: Record "Members Next Kin Details";
        ...
        ObjMemberSignatories: Record "Member Account Signatories";
        ...
        if ObjNOKAgentChange.FindSet then begin
            ...
            if ObjMemberNOKDetails.FindSet then begin
                repeat
                    ...
                    //ObjMemberNextofKinChange."Next Of Kin Type" :=ObjMemberNOKDetails.Relationship;
                    ObjMemberNextofKinChange.Insert;
    ...
    begin
        ...
        if ObjMemberSignatories.FindSet then begin
            repeat
                ...
                ObjMemberSignatoriesChange."Mobile Phone No" := ObjMemberSignatories."Mobile Number";
                ...
                ObjMemberSignatoriesChange."Member No." := ObjMemberSignatories."BOSA No.";
