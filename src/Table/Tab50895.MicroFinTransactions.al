    ...
    fields
    {
        ...
        field(5; "Group Code"; Code[20])
        {
            ...
            begin
                ...
                if MicroSubform.Find('-') then begin
                    //if MicroSubform.Count > 1 then begin
                ...
                if Member.Find('-') then begin
                    ...
                    "CEEP Officer" := Member."Loan Officer Name";
        ...
        field(11; "Account No"; Code[20])
        {
            ...
            if ("Account Type" = const(Vendor)) Vendor where("Account Type" = const('ORDINARY'))
            else
            if ("Account Type" = const("Bank Account")) "Bank Account" where("Account Type" = const(Cashier))
            else
        ...
        {
            CalcFormula = sum(Micro_Fin_Schedule.Amount where("No." = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(28; "CEEP Officer"; Code[150])
        {
        }
        field(29; "Group Meeting Day"; Date)
        {
        }
