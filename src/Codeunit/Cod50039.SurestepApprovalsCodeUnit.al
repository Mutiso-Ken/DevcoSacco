...
codeunit 50039 "SurestepApprovalsCodeUnit"
{
    ...
    // In the procedure that handles loan approval completion
    procedure CompleteLoanApproval(LoanNo: Code[20])
    var
    ...
    begin
        ...
        if LoanApp.FindFirst() then begin
            LoanApp."Approval Status" := LoanApp."Approval Status"::Approved;
            LoanApp."Loan Status" := LoanApp."Loan Status"::Approved; // Add this line
            LoanApp.Modify();
        end;
    end;
}
