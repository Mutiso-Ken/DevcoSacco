...
Codeunit 50000 "Payroll Processing"
{
    trigger OnRun()
    begin
    end;
    ...
    begin
        ...
        if curBasicPay > 0 then begin
            ...
            if blnPaysNssf then
                ...
                if curGrossPay <= 108000 then begin
            ...
            curDefinedContrib := PayPension + curNSSF + curNHIF + CUrrHousingLevy;//curNSSF; //(curNSSF + curPensionStaff + curNonTaxable) - curMorgageReliefAmount
            ...
            if blnGetsPAYERelief then begin
                ...
                strTransDescription := 'SHA Relief';
                TGroup := 'TAX CALCULATIONS';
                TGroupOrder := 6;
                TSubGroupOrder := 8;
            ...
            currHousinglevyRelief := 0;
            // currHousinglevyRelief := (CUrrHousingLevy * 0.15);
            curTransAmount := currHousinglevyRelief;
            strTransDescription := 'Housing Relief';
            TGroup := 'TAX CALCULATIONS';
            TGroupOrder := 6;
            TSubGroupOrder := 10;
        ...
        curPAYE := (curTaxCharged - curReliefPersonal - NhifRelief - currHousinglevyRelief);
    ...
    procedure fnGetEmployeeNHIF(curBaseAmount: Decimal) SHA: Decimal
    var
        prNHIF: Record "Payroll NHIF Setup.";
    begin
        ...
        VitalSetup.Get();
        SHA := (curBaseAmount * (VitalSetup."SHA Rate" * 0.01));
    end;
