...
codeunit 50018 "SURESTEPAutomation"
{
                    ...
                    IF (LoanApp."Loan Product Type" <> 'OKOA') and (LoanApp."Loan Product Type" <> 'OVERDRAFT') and (LoanApp.Source <> LoanApp.Source::MICRO) then begin
                        ...
                        if LoanApp."Oustanding Interest" > 0 then begin
                            if RunningBalance > 0 then begin
                                ...
                                //---------------------DEBIT FOSA-------------------------------------------------
                                LineN := LineN + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineN, Gnljnline."transaction type"::"0",
                ...
                repeat
                    if RunningBalance > 0 then begin
                        ...
                        if PrincipleDue > 0 then begin
                            ...
                            LineN := LineN + 10000;
                            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineN, Gnljnline."transaction type"::Repayment,
                            Gnljnline."account type"::Customer, LoanApp."Client Code", Today, AmountToDeduct * -1, Format(LoanApp.Source), LoanApp."Loan  No.",
        ...
        if RunningBalance > 0 then begin
            ...
            if ((ObjVendor.Find('-')) and (Today >= StartDate)) then begin
                ...
                if ObjVendor."Outstanding Overdraft" > 0 then begin
                    ...
                    SFactory.FnCreateGnlJournalLineBalancedCashier(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineN, Gnljnline."transaction type"::"0", Gnljnline."account type"::Vendor,
        ...
        if RunningBalance > 0 then begin
            ...
            if ObjMember.Find('-') then begin
                ...
                if ObjMember."Current Shares" > 0 then begin
                    ...
                    //----------------------------------2.DEBIT VENDOR----------------------------------------------
                    LineN := LineN + 10000;
                    SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineN, Gnljnline."transaction type"::"0", Gnljnline."account type"::Vendor,
