...
Report 50250 "Account Closure Slip"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Members__FOSA_Outstanding_Balance_; FOSAInterest)
            {
            }
            ...
            column(Outstanding_Balance___Accrued_Interest___FOSA_Outstanding_Balance__FOSAInterest_FWithdrawal__InsFund__1_; "Outstanding Balance" + "Accrued Interest" + FOSAInterest + FWithdrawal + (InsFund * -1))
            {
            }
