        ...
        dataitem(Members; Customer)
        {
            ...
            dataitem(Loans; "Loans Register")
            {
                ...
                dataitem("Loan Guarantors"; "Loans Guarantee Details")
                {
                    ...
                    column(CommitedShares; CommitedShares)
                    {
                    ...
                    begin
                        if Loans.Get("Loan Guarantors"."Loan No") then begin
                            ...
                            CommitedShares := Loans."Outstanding Balance" * ("Loan Guarantors"."Amont Guaranteed" / Loans."Requested Amount");
                        end;
                        "Loan Guarantors"."Commited Shares" := CommitedShares;
                        "Commited Shares" := CommitedShares;
                    end;
                }
            }
        }
