...
Report 50515 "CEEP Officer Collections"
{
    DefaultLayout = RDLC;
    Caption = 'CEEP Officer Collection Report';
    RDLCLayout = './Layouts/CEEP OfficerCollection Report.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Loan Last Pay Date") order(ascending) where(Posted = const(true));
            RequestFilterFields = Source, "Loan  No.", "Client Code", "Branch Code", "Loan Officer", "Loan Product Type", "Date filter";
