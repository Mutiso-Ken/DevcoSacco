tableextension 50071 "FixedAssetExt" extends "Fixed Asset"
{
    fields
    {
        ...
        field(51516861; "Depreciation Amount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("FA Ledger Entry".Amount where("FA No." = field("No."), "FA Posting Type" = const("Depreciation"),
                                                                        "FA Posting Date" = field("FA Posting Date Filter"),
                                                                         Reversed = const(false)));
        }
        field(51516862; "Acquisition Amount"; Decimal)
        {
            FieldClass = FlowField;
