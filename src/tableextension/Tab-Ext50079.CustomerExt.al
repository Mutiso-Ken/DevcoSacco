tableextension 50079 "CustomerExt" extends Customer
{
    ...
    fields
    {
        ...
        {
            CalcFormula = max("Cust. Ledger Entry"."Posting Date" where("Customer No." = field("No."), "Transaction Type" = filter("Deposit Contribution" | Repayment | "Shares Capital")
                                                                       ));
            FieldClass = FlowField;
        }
        ...
        field(68083; "RepaymentLoan"; Decimal)
        {
            CalcFormula = - sum("Cust. Ledger Entry"."Amount Posted" where("Customer No." = field("No."),
        ...
        field(69202; Piccture; MediaSet)
        {
        }
        field(689203; Siggnature; MediaSet)
        {
            Caption = 'Signature';
        }
        field(69204; "Piccture File Name"; Text[250])
        {
        }
        field(69205; "Signature File Name"; Text[250])
        { }
        field(69206; "Piccture Mime Type"; Text[250])
        {
        }
        field(69207; "Signature Mime Type"; Text[250])
        {
        }
