        ...
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            dataitem("Loans Guarantee Details"; "Loans Guarantee Details")
            {
                ...
                begin
                    ...
                    LoanG.SetAutoCalcFields(LoanG."Outstanding Balance", LoanG."Guarantor Outstanding");
                    LoanG.SetFilter(LoanG."Outstanding Balance", '>%1', 100);
                    ...
                    AmountofFreeShares := AvailableG - GuaranteedAmount;
            ...
            begin
                ...
                if Cust.Get("Loans Register"."Client Code") then begin
                    ...
                    StatDeductions := StatDeductions + "Loans Register".Repayment;
                    if (Psalary > Repayment) or (Psalary = Repayment) or ("Loans Register"."Loan Product Type" = 'DIVIDEND ADVANCE') then
                ...
                if LoanType.Get("Loan Product Type") then begin
                    ...
                    If LoanType."Charge Interest Upfront" = true then begin
                        InterestUpfront := Round(("Loans Register"."Approved Amount" * (LoanType."Interest rate" * 0.01)), 0.01, '=');
                    end;
                    ...
                    Upfronts := LoanProcessingFee + InterestUpfront + LoanInsurance + LegalFee + DisbursementFee + "Deboost Commision" + "Deboost Amount" + ValuationFee + TopUpFee + TopUpComm + BRIGEDAMOUNT;
                    ...
                    if "Approved Amount" > 0 then begin
                        Upfronts := InterestUpfront + LoanProcessingFee + LoanInsurance + "Deboost Commision" + "Deboost Amount" + LegalFee + DisbursementFee + ValuationFee + TopUpFee + TopUpComm + BRIGEDAMOUNT;
                        Netdisbursed := ("Approved Amount" - Upfronts);
