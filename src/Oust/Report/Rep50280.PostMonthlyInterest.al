        ...
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            begin
                ...
                if loanapp.Find('-') then begin
                    repeat
                        //if not LoanType.Get(loanapp."Loan Product Type") then
                        // error('The product does not exist') else
                        if not LoanType.Get("Loans Register"."Loan Product Type") then begin
                            Message('Skipping Loan %1: Missing product type %2',
                                "Loans Register"."Loan  No.", "Loans Register"."Loan Product Type");
                            CurrReport.Skip();
                            exit;
                        end;
            ...
            begin
                ...
                //SetRange("Loan Status", "Loan Status"::Issued);
