    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Dividends Progression"; "Dividends Progression")
            {
                ...
                //DataItemTableView = sorting(Date) ORDER(Descending);
                DataItemTableView = sorting("Member No", Date) order(Ascending);
                ...
                dataitem("Sacco General Set-Up"; "Sacco General Set-Up")
                {
                    ...
                    column(Dividend_Year; "Sacco General Set-Up"."Dividend Year")
                    {
                    }
                }
            }
